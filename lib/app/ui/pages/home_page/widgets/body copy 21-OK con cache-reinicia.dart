...
class BodyState extends State<Body> with WidgetsBindingObserver {
              ...
              child: FutureBuilder<bool>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    debugPrint("+++++++++++++ integhra_webview !!!!!!!!!! WAITING........");
                    return const Center(child: CircularProgressIndicator());
                  } else {
                    debugPrint("+++++++++++++ integhra_webview !!!!!!!!!! PREVIO A Inappwebview - URL ${globals.uri}!!");
                    return InAppWebView(
  ...
  Future<bool> _clearCacheIfNeeded() async {
    if (_clearCacheOnNextLoad && _webViewController != null) {
      ...
      debugPrint("+++++++++++++ integhra_webview !!!!!!!!!! Clearing CACHE IN PROGRESS........");
      return true;
    }
    debugPrint("+++++++++++++ integhra_webview !!!!!!!!!! Clear CACHE NOT Needed! _clearCacheOnNextLoad: $_clearCacheOnNextLoad");
    return false;
  }
      ...
      callback: (args) {
        if (args.isNotEmpty) {
          ...
          if (data['type'] == 'APP_VERSION_URL') {
            ...
            debugPrint('Current  version name: $_currentVersionName and version code: $_currentVersionCode');

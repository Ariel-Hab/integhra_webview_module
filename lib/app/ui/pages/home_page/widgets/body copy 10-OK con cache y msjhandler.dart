...
//     // Registrar un segundo manejador para el mensaje de versión de la aplicación al cargar la página
//     controller.addJavaScriptHandler(
...
//           // Manejar la lógica de actualización del caché basada en la versión recibida
//           var data = jsonDecode(message);
//           if (data['type'] == 'APP_VERSION_URL') {
//             String versionName = data['data']['versionName'];
//             debugPrint('Received version name: $versionName');
            
//             // Actualizar el cache si la versión ha cambiado
//             controller.clearCache();
//             controller.reload();
//           }
//         }

...
class BodyState extends State<Body> with WidgetsBindingObserver {
  ...
  late Future<bool> _cacheFuture; // Future para la limpieza de cache
  ...
  void _initializeState() async {
    ...
    _cacheFuture = _clearCacheIfNeeded();
  }
  ...
  Widget build(BuildContext context) {
    return PopScope(
      canPop: true,     //*** OJO con false inhibe el back del celular para toda la app Integhra (para DFV)

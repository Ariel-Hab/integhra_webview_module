    ...
    try {
      ...
      if (call.method == "getCalculatedResult") {
        ...
        if (varEnvironment == 'devddns') {
          ...
          globals.uri = 'http://www.dev.integhra.com/#?distributortaxtype=${globals.distributortaxtype}&distributortaxid=${globals.distributortaxid}&authtoken=${globals.authtoken}&sessiontoken=${globals.sessiontoken}&username=${globals.user}&origin=$varOrigin&';
        } else if (varEnvironment == 'testinteghra') {
          globals.uri = 'http://www.test.integhra.com/#?distributortaxtype=${globals.distributortaxtype}&distributortaxid=${globals.distributortaxid}&authtoken=${globals.authtoken}&sessiontoken=${globals.sessiontoken}&username=${globals.user}&origin=$varOrigin&';
        } else if (varEnvironment == 'preprodinteghra') {
          globals.uri = 'https://www.preprod.integhra.com/#?distributortaxtype=${globals.distributortaxtype}&distributortaxid=${globals.distributortaxid}&authtoken=${globals.authtoken}&sessiontoken=${globals.sessiontoken}&username=${globals.user}&origin=$varOrigin&';
